...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    NIGHT_VISION_HELM("night_vision_helm", 15, new int[]{2, 5, 6, 2}, 9, SoundEvents.SPYGLASS_USE, 0.0F, 0.0F, () -> {
        return Ingredient.of(ItemInit.REDSTEEL_INGOT.get());
    });
    ...
    private ModArmorMaterials(String p_40474_, int p_40475_, int[] p_40476_, int p_40477_, SoundEvent p_40478_, float p_40479_, float p_40480_, Supplier<Ingredient> p_40481_) {
        ...
        this.repairIngredient = p_40481_.get();
    }
